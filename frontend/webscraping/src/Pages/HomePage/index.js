...
const HomePage = () => {
  ...
  useEffect(() => {
    const getdata = async () => {
      try {
        setLoading(true);
        const keyboradData = await axios.get(
          "https://theorybackend.herokuapp.com/keyboard"
        );
        const headgearData = await axios.get(
          "https://theorybackend.herokuapp.com/headgear"
        );
        const mouseData = await axios.get(
          "https://theorybackend.herokuapp.com/mouse"
        );
        setProductcard([
          ...keyboradData.data,
          ...headgearData.data,
      ...
      <div className="grid grid-cols-4">
        ...
        <div className="col-span-3">
          <div className="grid grid-cols-3 gap-4">
            ...
            {!loading && searchInput && allSearchProduct.length === 0 && (
              <p>Not Found...</p>
            )}
            {!loading &&
